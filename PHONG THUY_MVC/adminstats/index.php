	...
	<div class="container">
		<div class="row">
			...
			<div class="alert alert-success">
				...
				echo "TỔNG SỐ KHÁCH THAM QUAN:".$unique_visitors;
			...
			<div class="alert alert-info">
				...
				echo "LƯỢT XEM TRANG CAO NHẤT :".$maxcount;

				?></strong>
			</div><br>
			<div class="panel panel-primary">
				<div class="panel-heading text-center">LƯỢT XEM TRANG MỚI NHẤT&nbsp;&nbsp;(TỔNG SỐ TRANG ĐÃ XEM:<?php require_once("count_pages.php"); ?>)</div>
...
//mysql select query
		...
		<div class="row">
			<div class="panel panel-success">
				<div class="panel-heading text-center">THÔNG TIN NGƯỜI XEM&nbsp;&nbsp;</div>
				<div class="panel-body">
					<div class="table-responsive">
						<table class="table">
							<tr class="info">
