...
<html lang="en">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li><a href="blogs_view.php"><i class="fa fa-rss"></i>Bài Viết</a></li>
            <li><a href="blog_categories_view.php"><i class="fa fa-tags"></i>Danh Mục</a></li>
            <li><a href="blogs_view.php"><i class="fa fa-check"></i>Xuất Bản</a></li>
            <li><a href="#"><i class="fa fa-tasks"></i>Bản Nháp</a></li>
            <?php
            $usernow=getLoggedMemberID();
            if ($usernow=="admin") {
            # code...show more links for admin only
            echo'<li><a href="titles_view.php"><i class="fa fa-desktop"></i>Chi Tiết Web</a></li>
            <li><a href="links_view.php"><i class="fa fa-link"></i>Đường Dẫn</a></li>
            <li><a href="editors_choice_view.php"><i class="fa fa-trophy"></i>Xem Nhiều</a></li>
            <li><a href="../adminstats"><i class="fa fa-bar-chart-o"></i>Thống Kê</a></li>';
          }
          ?>
          </ul>
 ...
 <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><a href="../index.php"><i class="icon-dashboard" style="text-decoration:none;"></i> <strong>Về Website</strong></a></li>
