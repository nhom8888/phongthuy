              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Bài Viết</strong></p>
                  </div>
                </div>
              </div>
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Danh Mục</strong></p>
                  </div>
                </div>
              </div>
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Xuất bản</strong></p>
                  </div>
                </div>
              </div>
              <a href="blogs_view.php">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Bản Nháp</strong></p>
                  </div>
                </div>
              </div>
              <a href="#">
...
<footer class="footer footer-inverse">
      <div class="container">
        <div class="text-center">
          <small>Admin @2021 Phong Thủy Việt</small>
        </div>
      </div>
    </footer>
  </body>
