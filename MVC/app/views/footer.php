  <footer>
              ...
              <div class="footer-col">
                 ...
                 <div class="footer-col-content">
                    <ul class="social">
                       ...
                       <li><a target="_blank" href="#"><img height="32" width="32" src="<?php echo BASE_URL ?>/public/images/youtube.png">Youtube</a></li>
                    </ul>
                    <div class="clear"></div>
                 </div>
              </div>
                    ...
                    <ul class="icon_list">
                       <li>
                          <a href="#">
                             ...
                             <p class="text_li">
                                <span class="phone_footer">Hotline:0969696969 </span>
                                <span class="text_small">(Từ 8h đến 20h tất cả các ngày)</span>
                             </p>
                          </a>
                       </li>
                       <div class="clear"></div>
                       <li><a><i class="fa fa-envelope" aria-hidden="true"></i> Khuattaunanh202002@gmail.com</a></li>
     ...
     <div class="clear"></div>
     <div class="copyright">
        <h4 class="tkw9999">&copy; Bản quyền thuộc về Phong Thủy <a href="http://webextrasite.com/" rel="dofollow" target="_blank">
     </div>
  </footer>
