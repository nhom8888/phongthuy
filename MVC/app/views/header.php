 ...
 <body>
     <header>
         <div class="info_top">
             <div class="bg_in">
                 <p class="p_infor">
                     <span><i class="fa fa-envelope-o" aria-hidden="true"></i>Email: khuattuananh@gmail.com</span>
                     <span><i class="fa fa-phone" aria-hidden="true"></i> Hotline: 0969696969</span>
                 </p>
             </div>
         </div>
                         ...
                         <div class="cart_wrapper">
                             <div class="cols_50">
                                 <div class="hot_line_top">
                                     ...
                                     <br />
                                     <span class="red">Hồ Hoàn Kiếm Quận 3 Hà nội</span>
                                 </div>
                             </div>
                             <div class="cols_50">
                                 <div class="hot_line_top">
