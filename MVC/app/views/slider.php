             ...
             <div id="myCarousel" class="carousel slide" data-ride="carousel">
                 ...
                 <div class="carousel-inner">
                     <div class="item active">
                         <img src="<?php echo BASE_URL ?>/public/images/1.jpg" alt="Mô hình DC" width="100%">
                     </div>

                     <div class="item">
                         <img src="<?php echo BASE_URL ?>/public/images/2.jpg" alt="Siêu khuyến mãi" width="100%">
                     </div>

                     <div class="item">
                         <img src="<?php echo BASE_URL ?>/public/images/3.jpg" alt="Siêu khuyến mãi" width="100%">
                     </div>

                     <div class="item">
                         <img src="<?php echo BASE_URL ?>/public/images/4.jpg" alt="Siêu khuyến mãi" width="100%">
                     </div>
                 </div>
