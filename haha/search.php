...
<body>
	...
	<section class="main-content-w3layouts-agileits">
		<div class="container">
			<h3 class="tittle">Kết quả tìm kiếm</h3>
			<div class="inner-sec">
				<?php  if ($row_count==0) {
		# code...
    						echo "<p style=color:#E9573F><b>Không tìm thấy :<u style=color:black>$search_keyword</u> </b></p>";
    						echo "<p><b style=color:#4FC1E9>Gợi ý<b><br>Tìm kiếm của bạn không có sẵn trên Trang web của chúng tôi<br>Cố gắng cụ thể hơn với các từ chính<br>Nhập từ khóa bằng tiêu đề<br>Thử lại sau<br></p>";
    						echo "<p><a href=\"http://www.google.com/search?q=" 
    						. $search_keyword . "\" target=\"_blank\" title=\"Look up 
    						" . $search_keyword . " on Google\" style=color:#37BC9B>Bấm vào đây</a> Tìm kiếm trên Google</p>";
    					}
    					else{
    						echo "<p style=color:#4FC1E9><b>Bạn tìm kiếm:<u style=color:black> $search_keyword</u></b></p>";
    						echo "<p style=color:#37BC9B><b>Kết quả($row_count)..</b></p>";
    					}
    					?>
				<!--left-->
					...
					<div class="row">
						...
						<div class="col-lg-4 card">
							...
							<div class="card-body">
								...
								<a href="single.php?id=<?php echo $row['id']; ?>" class="btn btn-primary read-m">Xem ngay</a>
							</div>
						</div>
						<?php
                                  }
