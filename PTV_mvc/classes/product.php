...
<?php
	...
	class product
	{
		...
		public function insert_product($data,$files){
			...
			if($productName=="" || $brand=="" || $category=="" || $product_desc==""  ||  $file_name ==""){
				$alert = "<span class='error'>Không được để trống</span>";
				return $alert;
			}else{
				move_uploaded_file($file_temp,$uploaded_image);
				$query = "INSERT INTO tbl_product(productName,brandId,catId,product_desc,image) VALUES('$productName','$brand','$category','$product_desc','$unique_image')";
			...
			if($sliderName==""  ){
				...
				if(!empty($file_name)){
					...
					if ($file_size > 2048000) {
		    		 ...
		    		 $alert = "<span class='success'>Tệp ảnh nhỏ hơn 2MB</span>";
					return $alert;
				    } 
		...
		public function insertCompare($productid, $customer_id){
			...
			$query_insert = "INSERT INTO tbl_compare(productId,price,image,customer_id,productName) VALUES('$productid','$image','$customer_id','$productName')";
		...
		public function insertWishlist($productid, $customer_id){
			...
			$query_insert = "INSERT INTO tbl_wishlist(productId,image,customer_id,productName) VALUES('$productid','$image','$customer_id','$productName')";
